...
#Networkx pulls up this function to calculte the weight of each edge 
def safe_weight(u, v, data):
    ...
    return length * (1 + 10.0 * risk) #Thats our weight, the 10 can be adjusted. 
...
def get_routes(start, end):
    ...
    #This transsforms the route into geodataframe which we need for the map visualization
